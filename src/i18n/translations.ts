...
export const translations: Record<'fr' | 'en', TranslationSchema> = {
  fr: {
    ...
    about: {
      ...
      sfaxBadge: 'Usine de Production',
      sfaxTitle: 'Sfax (Usine)',
      sfaxDesc: 'Notre usine principale et centre de production abritant la fabrication de pointe, la recherche et le contrôle qualité.',
      sfaxPoudriereBadge: 'Siège Social',
      sfaxPoudriereTitle: 'Sfax (Poudrière)',
      sfaxPoudriereDesc: 'Notre siège social et centre de décision commerciale, administrative et logistique.',
    ...
    contact: {
      ...
      sfaxHeadquarters: 'Siège Social Sfax (Poudrière)',
  ...
  en: {
    ...
    about: {
      ...
      sitesTitle: 'Our Sites',
      sitesSubtitle: 'A strategic presence to efficiently meet your needs across the entire territory and internationally.',
      sfaxBadge: 'Production Facility',
      sfaxTitle: 'Sfax (Factory)',
      sfaxDesc: 'Our main manufacturing facility housing advanced production lines, research, and quality control.',
    ...
    products: {
      ...
      statCategories: 'Products',
      statFood: 'Food-Grade Safety',
    ...
    contact: {
      ...
      sfaxHeadquarters: 'Sfax Headquarters (Poudriere)',
